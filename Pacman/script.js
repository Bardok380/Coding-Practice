...
(function () {
    ...
    // Map Legend: # wall, . dot, 0 power, P pac spawn, G gate (eyes only), H ghost spawn, ' ' empty
    const MAP = [
        "############################",
        "#............##............#",
        "#.####.#####.##.#####.####.#",
    ...
    function idGate(c,r){ return MAP[r][c]==="G"; }
    ...
    function updatePac(){
        ...
        if(p.want && (p.want.x !== p.dir.x || p.want.y !== p.dir.y)){
    ...
    // Render
    function render(){
        // clear to panel color (grid reeds well over photo page background)
